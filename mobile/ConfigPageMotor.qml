...
Item {
    ...
    function updateEditors() {
        ...
        case "PID Controllers":
            ...
            addSeparator("LQR Speed Controller")
            createEditorMc("s_lqr_A00")
            createEditorMc("s_lqr_A01")
            createEditorMc("s_lqr_A10")
            createEditorMc("s_lqr_A11")
            createEditorMc("s_lqr_B0")
            createEditorMc("s_lqr_B1")
            createEditorMc("s_lqr_C0")
            createEditorMc("s_lqr_C1")
            createEditorMc("s_lqr_K0")
            createEditorMc("s_lqr_K1")
            createEditorMc("s_lqr_L0")
            createEditorMc("s_lqr_L1")
